...
import random
try:
    from medsim.query_model import query_model, BAgent, extract_question, generate_possible_diagnoses, generate_answer_choices
except ImportError:
    from query_model import query_model, BAgent, extract_question, generate_possible_diagnoses, generate_answer_choices
import logging
