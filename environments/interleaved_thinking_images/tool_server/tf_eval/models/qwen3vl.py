...
logger = get_logger("qwen3vl_model",)

class Qwen3VL(tp_model):
    def __init__(
        self,
        pretrained: str = None,
    ...
    def generate(self, batch):
        ...
        for item in batch:
            print("idx", item.meta_data.get("idx"), "len(model_response)=", len(item.model_response))
        print("time: form_input", t1-t0, "generate", t2-t1, "decode", t3-t2)
